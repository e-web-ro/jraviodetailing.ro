    ...
    <main>
      ...
      <section className="hero">
        ...
        >
          ...
          >
            ...
            <a href="https://wa.me/40764641169" target="_blank" rel="noopener noreferrer" className="btn btn-outline">Programeaza Acum</a>
          </motion.div>
        </motion.div>
        ...
        <div className="container">
          <div className="about-grid">
            ...
            >
              ...
              <a href="https://wa.me/40764641169" target="_blank" rel="noopener noreferrer" className="btn btn-primary" style={{ marginTop: '2rem' }}>
      ...
      <style jsx>{`
        ...
        .popular-badge {
          ...
          margin: -3.2rem auto 2rem; /* Keep it in-flow, centered */
          background: #ff3b3b;
          color: white;
          padding: 0.6rem 2rem;
          border-radius: 50px;
