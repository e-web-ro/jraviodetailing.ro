        ...
        <div className="contact-container">
          ...
          >
            ...
            <div className="cta-buttons">
              <a href="tel:0764641169" className="btn btn-primary btn-large">
                <Phone size={24} style={{ marginRight: '10px' }} /> Suna Acum
              </a>
              <a href="https://wa.me/40764641169" target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp btn-large">
